...
public class MnistImageFile extends MnistDbFile {
	...
	/**
	 * Read the specified number of images from the current position, to a
	 * byte[nImages][rows*cols] Note that MNIST data set is stored as unsigned
	 * bytes; this method returns signed bytes without conversion (i.e., same
	 * bits, but requires conversion before use)
	 * 
	 * @param nImages
	 *            Number of images
	 */
